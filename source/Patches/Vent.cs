    ...
    public static class VentPatches
    {
        ...
        { 
            ...
            if (player.Is(RoleEnum.Engineer) || (player.roleAssigned && playerInfo.Role?.Role == RoleTypes.Engineer) ||
                ...
                (player.Is(RoleEnum.Arsonist) && CustomGameOptions.ArsonistVent) || (player.Is(RoleEnum.Vulture) && CustomGameOptions.VultureVent) ||
                CustomGameOptions.EveryoneVenting || (player.Is(RoleEnum.Juggernaut) && CustomGameOptions.JuggVent) ||
