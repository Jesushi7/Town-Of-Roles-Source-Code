...
namespace TownOfUs.Roles.Modifiers
{
    public class Assassin : Ability
    {
        ...
        public Assassin(PlayerControl player) : base(player)
        {
            ...
            if (CustomGameOptions.InvestigatorOn > 0) ColorMapping.Add("Detective", Colors.Investigator);
            if (CustomGameOptions.TimeLordOn > 0) ColorMapping.Add("Chronos", Colors.TimeLord);
            if (CustomGameOptions.MedicOn > 0) ColorMapping.Add("Medic", Colors.Medic);
            if (CustomGameOptions.SeerOn > 0) ColorMapping.Add("Snitch", Colors.Seer);
            ...
            if (CustomGameOptions.VigilanteOn > 0) ColorMapping.Add("Gambler", Colors.Vigilante);
