    ...
    public class Vigilante : Role
    {
        ...
        public Vigilante(PlayerControl player) : base(player)
        {
            ...
            if (CustomGameOptions.GameMode != GameMode.KillingOnly)
            {
                ...
                if (CustomGameOptions.PoisonerOn > 0) ColorMapping.Add("Vampire", Colors.Impostor);
                ...
                if (CustomGameOptions.VigilanteGuessLovers && CustomGameOptions.DisperserOn > 0) ColorMapping.Add("Disperser", Colors.Impostor);
                if (CustomGameOptions.VigilanteGuessLovers && CustomGameOptions.UnderdogOn > 0) ColorMapping.Add("Underdog", Colors.Impostor);
                if (CustomGameOptions.VigilanteGuessLovers && CustomGameOptions.DoubleShotOn > 0) ColorMapping.Add("Double Shot", Colors.Impostor);
                if (CustomGameOptions.AssassinGuessModifiers && CustomGameOptions.ButtonBarryOn > 0) ColorMapping.Add("Button Barry", Colors.ButtonBarry);
